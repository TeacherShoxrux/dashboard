...
class EquipmentRepository with BaseRepository{
  ...
  Future<BaseResponse<List<EquipmentModel>>> getEquipments() async {
  ...
  Future<BaseResponse<List<BrandModel>>> getBrands() async {
    return safeApiCall(
  ...
  Future<BaseResponse<List<CategoryModel>>> getCategories(int id) async {
